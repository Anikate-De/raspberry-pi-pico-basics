...
while True:
    try:
        ...
        # Check if fifo data is ready
            ...
            gz = to_short(mpu.get_rotation()[2])
            gz = int(input('Enter the value of GZ: (-100,100) '))
            duty_delta_acw = rangify(
                gz, init_start=-100, init_end=100, final_start=-0.25, final_end=0.25)
            ...
            duty_delta_cw = rangify(-gz, init_start=-100,
                                    init_end=100, final_start=-0.25, final_end=0.25)
