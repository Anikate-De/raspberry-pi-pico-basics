...
<body>
    ...
    <script>
        document.getElementsByClassName('buttonON')[0].addEventListener('click', async function () { fetch('http://192.168.0.154/led=on', { method: "POST", headers: {} }); });
        document.getElementsByClassName('buttonOFF')[0].addEventListener('click', async function () { fetch('http://192.168.0.154/led=off', { method: "POST", headers: {} }); });
    </script>
</body>
